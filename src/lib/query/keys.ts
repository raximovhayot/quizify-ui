...
export const queryKeys = {
  ...
  quizzes: {
    ...
    list: (params?: Record<string, unknown>) => [...queryKeys.quizzes.lists(), params] as const,
  ...
  assignments: {
    ...
    list: (params?: Record<string, unknown>) => [...queryKeys.assignments.lists(), params] as const,
  ...
  attempts: {
    ...
    list: (params?: Record<string, unknown>) => [...queryKeys.attempts.lists(), params] as const,
