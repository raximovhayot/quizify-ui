...
export class MockUtils {
   ...
   */
  static createMockQuiz(overrides?: Partial<{
    id: string;
    title: string;
    description: string;
    subject: string;
   ...
   */
  static createMockAssignment(overrides?: Partial<{
    id: string;
    title: string;
    description: string;
    subject: string;
   ...
   */
  static createMockApiResponse<T>(data: T, errors: Array<{ code: string; message: string }> = []) {
    return {
      data,
      errors
    };
   ...
   */
  static createMockApiError(code: string, message: string) {
    return {
      data: null,
      errors: [{ code, message }]
    };
